...
export default function GasInstallationInvoicePrint() {
  ...
  async function loadInvoice() {
    try {
      ...
      if (installationError || !installationData) {
        ...
        setError("Installation invoice could not be loaded.");
        return;
      }
  ...
  return (
    <div style={pageStyle}>
      <div style={toolbarStyle} className="no-print">
        <Link to={`/gas/installations/${installation.id}`}>
          <button style={secondaryButtonStyle}>Back to Quote</button>
        </Link>
      ...
      <div style={invoiceStyle}>
        <div style={headerStyle}>
          <div>
            ...
            <p style={{ margin: "6px 0", color: "#555" }}>
              Gas Installation Invoice
            </p>
            {business?.is_demo && (
              <strong style={{ color: "green" }}>DEMO INVOICE</strong>
            )}
          </div>
          ...
          <div style={{ textAlign: "right" }}>
            ...
            <p style={{ margin: "6px 0" }}>
              Invoice No: INST-{String(installation.id).slice(0, 8)}
            </p>
            <p style={{ margin: "6px 0" }}>
              Date:{" "}
              {new Date(
        ...
        <table style={tableStyle}>
          ...
          <tbody>
            ...
            {invoiceLines.length === 0 && (
              <tr>
                <td style={tdLeftStyle}>Gas installation service</td>
          ...
          <tfoot>
            <tr>
              ...
              <td style={totalValueStyle}>{money(invoiceTotal)}</td>
            </tr>
          </tfoot>
        </table>
        ...
        <div style={notesStyle}>
          <h3>Notes</h3>
          <p>
            This invoice is generated from the GrowthGrid Gas Installation
            system.
          </p>
          <p>
            Please confirm final payment terms, VAT handling, and COC details
